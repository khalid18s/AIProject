...
def classify_images(images_dir, results_dic, model):
    ...
    print("\nspace\n")
    print(results_dic['cat_07.jpg'])
    print("\nspace\n")
    filenames = listdir(images_dir) 
    filename_list = listdir(images_dir)
    # "pet_images/"filename_list
    classifier_labels = []
    
    for idx in range (0, len(filename_list), 1):
        filename_list[idx] = images_dir+filename_list[idx]
        #print(filenames[idx])
        classifier_labels.append(classifier(filename_list[idx], model))
        classifier_labels[idx].lower()
...
#
    ...
    print("\nclassifier_labels\n")
    i=0
    for i, key in enumerate(results_dic):
        results_dic[key] = [ results_dic[key] , classifier_labels[i]]
